import os, psutil, sys, jwt, pickle, json, binascii, time, urllib3, xKEys, base64, datetime, re, socket, threading
import asyncio
...
port = int(os.environ.get("PORT", 20107))
...
def home():
    ...
    <ul>
        <li><strong>بدء السبام:</strong> GET /spam?user_id=12345678&amp;duration=5 (duration اختياري - بالدقائق)</li>
        <li><strong>إيقاف السبام:</strong> GET /stop?user_id=12345678</li>
